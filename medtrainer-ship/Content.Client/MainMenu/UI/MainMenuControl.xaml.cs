...
public sealed partial class MainMenuControl : Control
{
    ...
    public MainMenuControl(IResourceCache resCache, IConfigurationManager configMan)
    {
        ...
        var pixelFont = resCache.GetResource<FontResource>("/Fonts/_FarHorizons/VT323/vt323-latin-400-normal.ttf");
        OfflinePracticeLabel.FontOverride = new VectorFont(pixelFont, 32);
    }
}
